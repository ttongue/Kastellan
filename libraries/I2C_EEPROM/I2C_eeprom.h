...
public:
    ...
    bool verifyBlock(const uint16_t memoryAddress, uint8_t* buffer, const uint16_t length);
    ...
    uint16_t generateChecksum(uint8_t* buffer, const uint16_t length);
